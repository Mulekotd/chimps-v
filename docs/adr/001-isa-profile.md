...
O núcleo declara somente o subconjunto que possui decoder, execução e testes. O alvo
é RV32IMF_Zicsr, mas marcos intermediários rejeitam extensões ainda não integradas.
Instruções inválidas, desalinhamento e `ECALL`/`EBREAK` entram em trap preciso.
