...
Atualizei [TASKS.md](/TASKS.md) e [docs/microarchitecture-audit.md](/docs/microarchitecture-audit.md) para refletir:
...
- a unidade RV32M e seu testbench como implementação isolada ainda pendente de execução no container e integração ao decoder/core;
