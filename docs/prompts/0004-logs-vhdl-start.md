...
Quero iniciar a implementação dos circuitos em VHDL. Por onde eu devo começar? Quais circuitos eu devo desenvolver levendo em consideração a microarquitetura (atual) que estruturamos?
